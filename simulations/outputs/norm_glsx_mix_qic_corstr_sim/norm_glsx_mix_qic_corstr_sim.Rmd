...
Based on these results, it appears that the correlation structure was selected appropriately every single time regardless of how the likelihood framework used to define the goodness-of-fit term. Thus, on average, the models selected have mean structures that includes all the non-zero coefficients at minimum and the proper correlation structure.