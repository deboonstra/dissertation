...
graphics::plot(
  1, xlim = c(0, 100), ylim = c(-20, 100), type = "n",
  axes = FALSE, ylab = "CIC", xlab = "Index"
)
graphics::axis(side = 1, at = seq(from = 0, to = 100, by = 10))
labs_yaxt <- seq(from = -20, to = 100, by = 20)
labs_yaxt <- ifelse(labs_yaxt == 100, "100+", as.character(labs_yaxt))
graphics::axis(
  side = 2, at = seq(from = -20, to = 100, by = 20),
  labels = labs_yaxt
)
...
graphics::plot(
  1, xlim = c(0, 100), ylim = c(-20, 100), type = "n",
  axes = FALSE, ylab = "QIC", xlab = "Index"
)
graphics::axis(side = 1, at = seq(from = 0, to = 100, by = 10))
labs_yaxt <- seq(from = -20, to = 100, by = 20)
labs_yaxt <- ifelse(labs_yaxt == 100, "100+", as.character(labs_yaxt))
