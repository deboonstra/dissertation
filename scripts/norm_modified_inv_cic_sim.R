...
if (!dir.exists("./outputs/norm-modified-inv-cic-sim")) {
  dir.create("./outputs/norm-modified-inv-cic-sim")
}
...
save(
  ...
  file = "./outputs/norm-modified-inv-cic-sim/norm_modified_inv_cic_sim.RData"
)
