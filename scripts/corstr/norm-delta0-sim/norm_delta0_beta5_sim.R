...
if (!dir.exists("./outputs/corstr/norm-delta0-sim/norm-delta0-beta5-sim/")) {
  dir.create("./outputs/corstr/norm-delta0-sim/norm-delta0-beta5-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta0-beta5-sim/norm_delta0_beta5_sim.rds"
  )
)