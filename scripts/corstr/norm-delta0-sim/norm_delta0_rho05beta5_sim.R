...
if (!dir.exists("./outputs/corstr/norm-delta0-sim/norm-delta0-rho05beta5-sim/")) { #nolint
  dir.create("./outputs/corstr/norm-delta0-sim/norm-delta0-rho05beta5-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta0-rho05beta5-sim/norm_delta0_rho05beta5_sim.rds"
  )
)