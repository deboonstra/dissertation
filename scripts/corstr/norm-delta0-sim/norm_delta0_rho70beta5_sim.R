...
# For these simulations there will be five non-zero coefficients used to
# generate the response. Thus, the delta values should hava a minimum value
# of six, which includes the intercept term.
# Additionally, the correlation coefficient will be 0.70.
...
if (!dir.exists("./outputs/corstr/norm-delta0-sim/norm-delta0-rho70beta5-sim/")) { #nolint
  dir.create("./outputs/corstr/norm-delta0-sim/norm-delta0-rho70beta5-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta0-rho70beta5-sim/norm_delta0_rho70beta5_sim.rds"
  )
)