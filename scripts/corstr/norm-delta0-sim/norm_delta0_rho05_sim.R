...
if (!dir.exists("./outputs/corstr/norm-delta0-sim/norm-delta0-rho05-sim/")) {
  dir.create("./outputs/corstr/norm-delta0-sim/norm-delta0-rho05-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta0-rho05-sim/norm_delta0_rho05_sim.rds"
  )
)