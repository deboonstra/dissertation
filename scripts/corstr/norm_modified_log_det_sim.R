...
if (!dir.exists("./outputs/norm-modified-log-det-sim")) {
  dir.create("./outputs/norm-modified-log-det-sim")
}
...
save(
  ...
  file = "./outputs/norm-modified-log-det-sim/norm_modified_log_det_sim.RData"
)