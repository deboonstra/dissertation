...
# However, the correlation coefficient will be set to 0.7.
...
if (!dir.exists("./outputs/corstr/norm-delta-sim/norm-delta-rho70-sim/")) {
  dir.create("./outputs/corstr/norm-delta-sim/norm-delta-rho70-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta-rho70-sim/norm_delta_rho70_sim.rds"
  )
)