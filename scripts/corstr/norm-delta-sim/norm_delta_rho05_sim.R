...
# However, the correlation coefficient will be 0.05.
...
if (!dir.exists("./outputs/corstr/norm-delta-sim//norm-delta-rho05-sim/")) {
  dir.create("./outputs/corstr/norm-delta-sim//norm-delta-rho05-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta-rho05-sim/norm_delta_rho05_sim.rds"
  )
)