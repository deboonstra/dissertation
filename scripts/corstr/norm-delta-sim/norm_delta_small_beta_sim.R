...
# where the beta coefficients are small.
...
sub_dir <- "./outputs/corstr/norm-delta-sim/norm-delta-small-beta-sim/"
...
beta <- c(0.002, 0.003, 0.0005, 0, 0, 0)
...
saveRDS(
  object = res,
  file = paste0(sub_dir, "norm_delta_small_beta_sim.rds")
)