...
if (!dir.exists("./outputs/corstr/norm-delta-sim/norm-delta-eo-sim/")) {
  dir.create("./outputs/corstr/norm-delta-sim/norm-delta-eo-sim/")
}
...
save(
  ...
  file = paste0(
    ...
    "norm-delta-eo-sim/norm_delta_eo_sim.RData"
  )
)