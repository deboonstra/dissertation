...
# selection properties of a information criterion initial called delta, but is
# now called Variance Information Criteria (VIC). This simulation differs from
# norm_delta_sim.R, as it is using a different paradigm to generate the design
# matrix.
...
sub_dir <- "./outputs/corstr/norm-delta-sim/norm-delta-diff-xdata-sim/"
...
saveRDS(
  object = res,
  file = paste0(sub_dir, "norm_delta_diff_xdata_sim.rds")
)