...
# However, there will be five non-zero mean parameters in these simulations.
...
if (!dir.exists("./outputs/corstr/norm-delta-sim/norm-delta-beta5-sim/")) {
  dir.create("./outputs/corstr/norm-delta-sim/norm-delta-beta5-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta-beta5-sim/norm_delta_beta5_sim.rds"
  )
)