...
# the correlation coefficient will be 0.70.
...
if (!dir.exists("./outputs/corstr/norm-delta-sim/norm-delta-rho70beta5-sim/")) {
  dir.create("./outputs/corstr/norm-delta-sim/norm-delta-rho70beta5-sim/")
}
...
saveRDS(
  ...
  file = paste0(
    ...
    "norm-delta-rho70beta5-sim/norm_delta_rho70beta5_sim.rds"
  )
)