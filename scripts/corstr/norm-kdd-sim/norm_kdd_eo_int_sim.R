...
if (!dir.exists("./outputs/corstr/norm-kdd-sim/norm-kdd-eo-int-sim/")) {
  dir.create("./outputs/corstr/norm-kdd-sim/norm-kdd-eo-int-sim/")
}
...
save(
  ...
  file = "./outputs/corstr/norm-kdd-sim/norm-kdd-eo-int-sim/sim_res.RData"
)