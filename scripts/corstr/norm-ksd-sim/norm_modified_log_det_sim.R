...
# properties of the modified logarithm of the determinants. For information
# about this simulation, see the meeting notes for 2023-09-28 and the document
# explaining this simulation:
# `outputs/norm-modified-log-det-sim/norm_modified_log_det_sim.Rmd`.
...
if (!dir.exists("./outputs/corstr/norm-ksd-sim/norm-modified-log-det-sim")) {
  dir.create("./outputs/corstr/norm-ksd-sim/norm-modified-log-det-sim")
}
...
save(
  ...
  file = paste0(
    ...
    "norm-modified-log-det-sim/norm_modified_log_det_sim.RData"
  )
)