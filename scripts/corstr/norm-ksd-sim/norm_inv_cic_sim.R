...
# properties of inverted CIC. For information about this simulation, see the
...
if (!dir.exists("./outputs/corstr/norm-ksd-sim/norm-inv-cic-sim")) {
  dir.create("./outputs/corstr/norm-ksd-sim/norm-inv-cic-sim")
}
...
save(
  ...
  file = "./outputs/corstr/norm-ksd-sim/norm-inv-cic-sim/norm_inv_cic_sim.RData"
)