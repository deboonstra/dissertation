...
if (!dir.exists("./outputs/corstr/norm-ksd-sim/norm-ksd-eo-int-sim/")) {
  dir.create("./outputs/corstr/norm-ksd-sim/norm-ksd-eo-int-sim/")
}
...
save(
  ...
  file = paste0(
    "./outputs/corstr/norm-ksd-sim/norm-ksd-eo-int-sim/sim_res.RData"
  )
)