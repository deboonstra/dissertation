...
# properties of modified inverted CIC. For information about this simulation,
...
if (!dir.exists("./outputs/corstr/norm-ksd-sim/norm-modified-inv-cic-sim")) {
  dir.create("./outputs/corstr/norm-ksd-sim/norm-modified-inv-cic-sim")
}
...
save(
  ...
  file = paste0(
    ...
    "norm-modified-inv-cic-sim/norm_modified_inv_cic_sim.RData"
  )
)
